extends RefCounted
## Table centrale des noms de nains, tires au hasard a la creation de chaque
## nain (voir Dwarf.gd).
##
...
## public, ~13e siecle) - c'est la source dans laquelle Tolkien lui-meme a
## puise la plupart des noms de ses nains (Thorin, Dvalin, Fili, Kili,
## Bombur, etc. en sont directement issus). Utiliser cette liste donne le
## style "nain classique" sans reprendre de noms de personnages d'une oeuvre
## protegee. Completee par des prenoms feminins authentiques du vieux
## norrois (themes bataille/nature, coherents avec la sonorite du
...
## Tire un nom complet aleatoire "Prenom Nom-de-clan", via un flux
## GameRandom dedie ("nains_noms") pour rester deterministe a graine egale.
